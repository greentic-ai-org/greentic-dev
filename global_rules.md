...
- greentic-dev is a pass-through CLI: prefer delegating semantics to upstream crates (`greentic-flow`, `greentic-component`, `greentic-distributor-client`, `packc`, `greentic-runner`). Do not add new flow/component semantics here unless explicitly required.
